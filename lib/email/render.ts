...
async function renderTemplate(
  ...
  getSubject: (payload: NotificationTemplatePayload) => string,
...
export async function renderEmailTemplate(type: NotificationType, payload: NotificationTemplatePayload): Promise<RenderedEmail> {
  switch (type) {
    case "INVITE_CREATED": {
      ...
      return renderTemplate(VenueInviteEmail, payload, getSubject as (payload: NotificationTemplatePayload) => string);
    }
    case "SUBMISSION_SUBMITTED": {
      ...
      return renderTemplate(SubmissionSubmittedEmail, payload, getSubject as (payload: NotificationTemplatePayload) => string);
    }
    case "SUBMISSION_APPROVED": {
      ...
      return renderTemplate(SubmissionApprovedEmail, payload, getSubject as (payload: NotificationTemplatePayload) => string);
    }
    case "SUBMISSION_REJECTED": {
      ...
      return renderTemplate(SubmissionRejectedEmail, payload, getSubject as (payload: NotificationTemplatePayload) => string);
    }
    case "SAVED_SEARCH_MATCH": {
      ...
      return renderTemplate(SavedSearchMatchEmail, payload, getSubject as (payload: NotificationTemplatePayload) => string);
    }
    case "DIGEST_READY":
