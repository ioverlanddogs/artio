    ...
    <Tabs value={active} onValueChange={setTab} className="grid grid-cols-[200px_1fr] gap-6">
      ...
      <div>
        ...
        <TabsContent value="ingest-ai"><IngestSettingsClient initial={{
          ...
          artistLookupProvider: (initial.artistLookupProvider as string | null) ?? null,
          artistBioProvider: (initial.artistBioProvider as string | null) ?? null,
          ...
          regionAutoPublishVenues: Boolean(initial.regionAutoPublishVenues),
          regionAutoPublishEvents: Boolean(initial.regionAutoPublishEvents),
          regionAutoPublishArtists: Boolean(initial.regionAutoPublishArtists),
          enrichMatchedArtists: Boolean(initial.enrichMatchedArtists),
          regionAutoPublishArtworks: Boolean(initial.regionAutoPublishArtworks),
          regionDiscoveryEnabled: Boolean(initial.regionDiscoveryEnabled),
          regionMaxVenuesPerRun: (initial.regionMaxVenuesPerRun as number | null) ?? null,
