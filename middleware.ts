...
export async function middleware(req: NextRequest) {
  ...
  response.headers.set(
    ...
    "default-src 'self'; base-uri 'self'; frame-ancestors 'none'; child-src 'self' blob: https://vercel.live; img-src 'self' data: blob: https:; font-src 'self' data: https:; worker-src 'self' blob:; script-src 'self' 'unsafe-inline' https://vercel.live https://*.vercel-scripts.com; style-src 'self' 'unsafe-inline'; connect-src 'self' https://api.mapbox.com https://events.mapbox.com https://*.tiles.mapbox.com https: https://vercel.live;",
  );
  return response;
}
